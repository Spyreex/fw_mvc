						...
						<table class="min-w-full divide-y divide-gray-300">
							...
							<tbody class="divide-y divide-gray-200 bg-white">
								<?php foreach ($data["applicants"] as $applicant) : ?>
									<tr>
										<td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><?= $applicant->FirstName . " " . $applicant->LastName; ?></td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $applicant->Title; ?></td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $applicant->Gender; ?></td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?= $applicant->Place; ?></td>
										<td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
											<a href="applicant/edit/<?= $applicant->Id ?>" class="text-indigo-600 hover:text-indigo-900">Edit<span class="sr-only">, Lindsay Walton</span></a>
										</td>
									</tr>
								<?php endforeach; ?>
